		...
		if(data.retCode == "0000"){
			...
			if(result.total == 0){ //总条数
				...
				$(".scbg").click(function(){ //一键生成研报
					//console.log("dianji ")
					window.open("cover.html?stockCode="+$(this).attr("data-code")+"&stockName="+$(this).attr("data-name"));
				})
