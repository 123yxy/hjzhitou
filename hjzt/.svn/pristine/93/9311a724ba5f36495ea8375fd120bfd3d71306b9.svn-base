...
//	头部star
	var hed='<div class="header newheaders newSassHeader">';
		...
		hed+='<a href="/index.html"><img src="/saasBeta/images/logo3.png"/></a>';
	    	...
	    	//hed+='<a href="/index.html"><img src="/saasBeta/images/reg_logo.png"/></a>';
	    	///saasBeta/images/Image/Index/logo.png
		...
		hed+='<a href="/index.html">首页</a><a href="/threeLibrary/stockQuotes.html">资讯数据</a><a href="/security/myPreferredStock.html">自选股</a><a href="/myResearch/researchReport.html">我的研究</a><a href="/dataAnalysis/financingAnalysis.html">数据分析</a>';
		hed+='</div>';
		if(imageLs==""||imageLs==null||imageLs==undefined||imageLs=="null"){
			hed+='<div class="header_r fr"><a href="/personalCenter/personalInformation.html" class="fl" id="imageHead"><img src="/saasBeta/images/morenimg.png" alt="个人头像"></a><span class="fr" id="nameHead" onclick="javascript:window.location.href=\'/personalCenter/personalAlbum.html\'">'+userNameLs+'</span>';
		}else{
			hed+='<div class="header_r fr"><a href="/personalCenter/personalInformation.html" class="fl" id="imageHead"><img src="'+imageLs+'" alt="个人头像"></a><span class="fr" id="nameHead" onclick="javascript:window.location.href=\'/personalCenter/personalAlbum.html\'">'+userNameLs+'</span>';
		}
...
//});
//尾部star
var foot="<div class='footer2 newSassFoot'><p>版权所有：北京圣康汇金科技有限公司</p><a href='#' id='back_top'><img src='/saasBeta/images/icon/back_top.png' alt='返回顶部'  /></a></div>";
$("body").append(foot);
