(function($) {
	$.fn.tinyscrollbar = function(options) {
		...
		this.update = function() {
			...
			oTrack.obj.css(sSize, (oViewport[options.axis]<4) ? 15.5 : oViewport[options.axis]);
			...
			oThumb.obj.css(sSize, (oThumb[options.axis]<4 ? 15.5 : oThumb[options.axis]));
		...
		function drag(oEvent) {
			if(!(oContent.ratio >= 1)) {
				...
				oContent.obj.css(sDirection, -iScroll);
				oThumb.obj.css(sDirection, ((iPosition.now-10)<0 ? 0 : (iPosition.now-10)));;
			}
			return false;
		};
