...
(function ($) {
    $(function () {
        ...
        $iColor = $('<div id="iColorPicker" style="top:345px;left:745px;"><table class="pickerTable"><thead></thead><tbody><tr><td colspan="16" id="colorPreview"></td></tr></tbody></table></div>').css({
            'display': 'none', 
            'position': 'fixed'
            ...
            'click': function(evt) {
                ...
                var tcolor=$(t).attr("hx");
                console.log(tcolor);
                //获取到的颜色赋值给input
                $("#color .color_img").css("border-bottom","2px solid #"+tcolor)
               $(".input").css("color",'#'+tcolor);
