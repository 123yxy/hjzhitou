(function($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function() {
            ...
            content = '<button type="button" id="firstPage" class="turnPage first-page"><b></b></button>' +
                '<button class="turnPage" id="prePage"><b></b></button>' +
                '<div class="pageWrap" style="width:' + wrapLength + 'px">' +
                '<ul id="pageSelect" style="transition:all ' + that.options.slideSpeed + 'ms">' +
                ulDom +
                '</ul></div>' +
                '<button class="turnPage" id="nextPage"><b></b></button>' +
                '<button type="button" id="lastPage" class="last-page"><b></b></button>';
