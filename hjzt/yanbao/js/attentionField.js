...
(function getattention() {
	param = {};
	UTIL.axs(UTIL.CONFIG.findNotionCon, param, true, function (data) {
...
$("#save").on("click", function () {
	(getchecked.len > 2) ? UTIL.axs(UTIL.CONFIG.updateSignature, { field: "focusArea", value: getchecked.checkdata.join(',') }, true, function (_data) {
		// _data.retCode === "0000"? mui.toast('公司未填写', { duration: 'long', type: 'div' }):"";
		(_data.retCode === "0000") ?( localStorage.setItem('focusarea', getchecked.checkdata.join(',')),location.href = "userCenter.html") : "";//mui.toast('关注失败', { duration: 'long', type: 'div' })
