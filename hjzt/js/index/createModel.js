...
//		$(".yanjiu_neir").show();
//	})
	$("#createModel-click").on("click",function(){
		$("#modelSeachStock").val('');
		$("#modelZhibiao").html('');
...
//		html+='<li class="xiebg" onClick=window.location.href="/myResearch/editReport.html">';

//		html+='<i></i>';

//		html+='<a href="javascript:;">写报告</a>';
...
//		html+='<span onClick=window.location.href="/myResearch/editReport.html">立即创建研报</span>';
...
//		html+='</div>';
		var html='<div class="czzx_bg" style="display: none;"></div>';
		//<!--模型计算的弹窗-->
		...
		html+='<input type="text" class="ui-autocomplete-input-company" placeholder="输入分析股票简称或代码，按回车确认" id="modelSeachStock"/>';
		//未输入股票代码时显示的引导
