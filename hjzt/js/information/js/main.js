 ...
 * @param datas
 */
function createBootStrapChart(datass,tIds){
	console.log("in createBootStrapChart:")
	console.log(datass);
...
//	    edge.setStyle(Q.Styles.ARROW_TO_STROKE_STYLE, "#444");//箭头边框颜色
		...
		edge.setStyle(Q.Styles.EDGE_BUNDLE_LABEL_OFFSET_X,1000);
		//线条提示信息
...
//		console.log(x+"   "+y);
	...
	function createItem(datas){
	 ...
	 graph.zoomToOverview();  			data.y=max/2*step;
			}
	...
	ROOT.setStyle(Q.Styles.LABEL_FONT_SIZE, 15);
	ROOT.setStyle(Q.Styles.LABEL_SIZE, new Q.Size(3, 4));
