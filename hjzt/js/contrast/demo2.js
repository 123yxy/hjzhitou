...
//    		        	console.log(liHeight+"*"+indexNum+"="+(liHeight*indexNum));
//    		        	var divWidth=$(this).parent().parent().width();
//    		        	console.log(divWidth);
//    		        	while((liHeight*indexNum)>divWidth){
//    		        		
//    		        	}
    		        }
    		        $('div.diy_zhuti').append(htm);
...
//    			}
    			$(".diy_yx_box").html('<a href="javascript:;" title="'+$(this).text()+'" data-keyId="'+$(this).attr("data-keyId")+'">'+showName+'<i></i></a>');
//			}
    	}else{//标题单击
    		//已经选择
